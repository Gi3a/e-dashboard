...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getCookie, getQuery as getQuery$1, createError, getResponseStatusText } from 'file:///Users/gizatuteyev/Desktop/e-dashboard/node_modules/h3/dist/index.mjs';
import { createClient } from 'file:///Users/gizatuteyev/Desktop/e-dashboard/node_modules/@supabase/supabase-js/dist/main/index.js';
import defu, { defuFn, defu as defu$1 } from 'file:///Users/gizatuteyev/Desktop/e-dashboard/node_modules/defu/dist/defu.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/gizatuteyev/Desktop/e-dashboard/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/gizatuteyev/Desktop/e-dashboard/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/gizatuteyev/Desktop/e-dashboard/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///Users/gizatuteyev/Desktop/e-dashboard/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/gizatuteyev/Desktop/e-dashboard/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/gizatuteyev/Desktop/e-dashboard/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/gizatuteyev/Desktop/e-dashboard/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/gizatuteyev/Desktop/e-dashboard/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/gizatuteyev/Desktop/e-dashboard/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Users/gizatuteyev/Desktop/e-dashboard/node_modules/klona/dist/index.mjs';
import { hash } from 'file:///Users/gizatuteyev/Desktop/e-dashboard/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Users/gizatuteyev/Desktop/e-dashboard/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/gizatuteyev/Desktop/e-dashboard/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/gizatuteyev/Desktop/e-dashboard/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/gizatuteyev/Desktop/e-dashboard/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file:///Users/gizatuteyev/Desktop/e-dashboard/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/gizatuteyev/Desktop/e-dashboard/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/gizatuteyev/Desktop/e-dashboard/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "supabase": {
      "url": "https://icxffjgtyxtojlastxbu.supabase.co",
      "key": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImljeGZmamd0eXh0b2psYXN0eGJ1Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDA0OTY5NTQsImV4cCI6MjAxNjA3Mjk1NH0.ST1MsnT8AKuQhoMQlBixf-AQOWt3wx9zQAv8C6N0PmA",
      "redirect": true,
      "redirectOptions": {
        "login": "/login",
        "callback": "/confirm",
...
const serverAssets = [{"baseName":"server","dir":"/Users/gizatuteyev/Desktop/e-dashboard/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/gizatuteyev/Desktop/e-dashboard","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/gizatuteyev/Desktop/e-dashboard/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/gizatuteyev/Desktop/e-dashboard/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/gizatuteyev/Desktop/e-dashboard/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/gizatuteyev/Desktop/e-dashboard/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _CHlbLNwJrN = (function(nitro) {
...
const _lazy_M8410d = () => Promise.resolve().then(function () { return index_get$3; });
const _lazy_YSRtzd = () => Promise.resolve().then(function () { return index_get$1; });
const _lazy_NJ5P3V = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/appointments', handler: _lazy_M8410d, lazy: true, middleware: false, method: "get" },
  { route: '/api/businessess', handler: _lazy_YSRtzd, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_NJ5P3V, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_NJ5P3V, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Users/gizatuteyev/Desktop/e-dashboard/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/gizatuteyev/Desktop/e-dashboard/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
